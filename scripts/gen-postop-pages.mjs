...
const pages = [
  ...
  // NOTE: `post-op-instructions` is deliberately NOT generated.
  // app/post-op-instructions/page.tsx has since been hand-written (82 lines of
  // real JSX). Re-adding it here would silently overwrite that page on the next
  // run — and the old template body embedded JSX `{' '}` literals inside an HTML
  // string, so the regenerated page rendered those characters as visible text.
];
